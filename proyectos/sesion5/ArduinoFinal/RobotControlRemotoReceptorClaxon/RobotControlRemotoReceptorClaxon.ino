...
else if(frame.Joystick_eje_Y_data >= 130){
  velocity(frame.Joystick_eje_Y_data);
  Retroceder();
}

else if(frame.Joystick_eje_Y_data <= 120){
  int value = 255-frame.Joystick_eje_Y_data;
  velocity(value);
  Avanza();
}

else if(frame.Joystick_eje_X_data >= 140){
  velocity(frame.Joystick_eje_X_data);
  Derecha();
}

else if(frame.Joystick_eje_X_data <= 120){
  int value =255-frame.Joystick_eje_X_data;
  velocity(value);
  Izquierda();
}else{
  set_velocity(0);
...
void velocity(int coordenada){
byte value=coordenada;
set_velocity(value);
}
//-------------------
